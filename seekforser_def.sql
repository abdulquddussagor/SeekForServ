...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 03:29 AM
...
(1, 1, 'Gaddafy', 'seekforserv@gmail.com', 'uploads/website-images/gaddafy-2023-06-04-01-37-00-7858.jpg', NULL, '$2y$10$PuDIj.tM/io19nS9L3yjC.Jv/CVdTJEPRhCkb3fqdGF1Fr7JXElEy', NULL, 1, NULL, NULL, '2023-06-03 19:37:39');
...
(1, 2, 'Monday', '09:00', '18:00', 1, '2023-06-04 08:30:10', '2023-06-04 08:30:42'),
(2, 2, 'Tuesday', '09:00', '18:00', 1, '2023-06-04 10:26:58', '2023-06-04 10:26:58'),
(3, 2, 'Tuesday', '09:00', '18:30', 1, '2023-06-04 16:15:53', '2023-06-04 16:16:47');
...
(1, 1, 'Agree with this payment?', 'uploads/website-images/bank-2023-06-04-03-08-40-6615.png', NULL, '2023-06-04 09:23:00');
...
(1, 'Computer Technology', 'computer-technology', 'uploads/custom-images/category-2023-06-04-01-11-43-2022.png', NULL, 1, '2023-06-03 19:10:07', '2023-06-03 19:11:43'),
(2, 'AC Repair', 'ac-repair', 'uploads/custom-images/category-2023-06-04-01-17-53-8272.png', NULL, 1, '2023-06-03 19:17:54', '2023-06-03 19:17:54'),
(3, 'Car Service', 'car-service', 'uploads/custom-images/category-2023-06-04-01-21-34-1221.png', NULL, 1, '2023-06-03 19:21:34', '2023-06-03 19:21:34'),
(4, 'Cleaning', 'cleaning', 'uploads/custom-images/category-2023-06-04-01-23-50-3289.png', NULL, 1, '2023-06-03 19:23:50', '2023-06-03 19:23:50'),
(5, 'Painting', 'painting', 'uploads/custom-images/category-2023-06-04-01-25-57-5190.png', NULL, 1, '2023-06-03 19:24:34', '2023-06-03 19:25:58'),
(6, 'Plumbing', 'plumbing', 'uploads/custom-images/category-2023-06-04-01-31-03-9806.png', NULL, 1, '2023-06-03 19:31:03', '2023-06-03 19:31:03');
...
(11, 1, 'Sayed Nogor', 'sayed-nogor', 1, '2023-06-03 08:43:20', '2023-06-03 08:43:20'),
(12, 1, 'Baridhara', 'baridhara', 1, '2023-06-04 23:57:36', '2023-06-04 23:57:36'),
(13, 10, 'Chashara', 'chashara', 1, '2023-06-04 23:57:51', '2023-06-04 23:57:51');
...
(1, 'Bangladesh', 'bangladesh', 1, '2022-01-30 09:28:28', '2023-06-03 08:40:28');
...
(1, 1, 'Dhaka', 'dhaka', 1, '2022-01-30 09:29:00', '2023-06-03 08:41:27'),
(10, 1, 'Narayanganj', 'narayanganj', 1, '2023-06-04 18:22:33', '2023-06-04 18:22:33');
...
(1, 'Blog Page', 6, NULL, '2023-05-10 08:39:56'),
(2, 'Service Page', 9, NULL, '2023-05-10 10:18:39'),
(3, 'Provider Page', 8, NULL, '2023-05-10 02:14:01'),
(4, 'Blog Comment', 4, NULL, '2023-05-10 03:06:58'),
(5, 'Provider Review', 2, NULL, '2023-05-10 05:01:34');
...
(1, 2, 'smtp.mailtrap.io', '587', 'maryleynda12@gmail.com', 'mary+pass@', '045ae65cc34b16', '48889ee7937b65', 'tls', NULL, '2023-05-10 14:26:11');
...
(1, 'Password Reset', 'Password Reset', '<h4>Dear <b>{{name}}</b>,</h4>\r\n    <p>Do you want to reset your password? Please Click the following link and Reset Your Password.</p>', NULL, '2023-05-10 10:06:57'),
(2, 'Contact Email', 'Contact Email', '<p>Name: <b>{{name}}</b></p><p>\r\n\r\nEmail: <b>{{email}}</b></p><p>\r\n\r\nPhone: <b>{{phone}}</b></p><p><span style=\"background-color: transparent;\">Subject: <b>{{subject}}</b></span></p><p>\r\n\r\nMessage: <b>{{message}}</b></p>', NULL, '2023-05-09 23:44:34'),
(3, 'Subscribe Notification', 'Subscribe Notification', '<h2><b>Hi there</b>,</h2><p>\r\nCongratulations! Your Subscription has been created successfully. Please Click the following link and Verified Your Subscription. If you won\'t approve this link, after 24hourse your subscription will be denay</p>', NULL, '2023-04-30 23:44:53'),
(4, 'User Verification', 'User Verification', '<p>Dear <b>{{user_name}}</b>,\r\n</p><p>Congratulations! Your Account has been created successfully. Please Click the following link and Active your Account.</p>', NULL, '2023-05-14 23:45:25'),
...
(6, 'Order Successfully', 'Order Successfully', '<p>Hi {{user_name}},</p><p> \r\nThanks for your new order. Your order id has been submited .</p><p>Total Amount : {{total_amount}},</p><p>Payment Method : {{payment_method}},</p><p>Payment Status : {{payment_status}},</p><p>Order Status : {{order_status}},</p><p>Order Date: {{order_date}},</p><p>Order Detail: {{order_detail}}</p>', NULL, '2023-05-15 21:37:03'),
(8, 'New Order Mail to Client', 'New Order Mail to Client', '<p>Hi&nbsp;{{name}}, Thanks for your new order. Your order has been placed.</p><p>Order Id : {{order_id}}</p><p>Amount : {{amount}}</p><p>Schedule Date : {{schedule_date}}</p>', NULL, '2023-05-17 10:15:23'),
(9, 'New Order Mail to Provider', 'New Order Mail to Provider', '<p>Hi&nbsp;{{name}}, A new order has been placed to you .</p><p>Order Id : {{order_id}}</p><p>Amount : {{amount}}</p><p>Schedule Date : {{schedule_date}}</p>', NULL, '2023-05-18 10:16:22'),
(10, 'User Verification For OTP', 'User Verification', '<p>Dear <b>{{user_name}}</b>,\r\n</p><p>Congratulations! Your Account has been created successfully. Please Copy the code and verify your account</p>', NULL, '2023-05-18 23:45:25'),
(11, 'Password Reset For OTP', 'Password Reset', '<h4>Dear <b>{{name}}</b>,</h4>\r\n    <p>Do you want to reset your password? Please copy and past the code</p>', NULL, '2023-05-20 10:06:57');
...
(1, '+8801632030573', 'seekforserv@gmail.com', 'Notun Bazar, Badda, Dhaka', 'We are dedicated to work with all dynamic features like Laravel, customized website, PHP, SEO, etc.  We rely on new creation and the best management policy. We usually monitor the market and policies. We provide all web solutions accordingly and ensure the best service.', 'Important Link', 'Quick Link', 'Our Service', 'Copyright 2023 SeekForServ All Rights Reserved.', 'uploads/website-images/payment-card-2022-08-28-04-29-12-1387.png', NULL, '2023-06-03 23:15:18');
...
(1, 'Home', 'Home', 1, NULL, '2023-05-10 02:10:38'),
(2, 'About Us', 'About Us', 1, NULL, '2023-05-10 02:10:38'),
(3, 'Service', 'Service', 1, NULL, '2023-05-10 02:10:38'),
(4, 'Pages', 'Pages', 0, NULL, '2023-06-03 08:38:54'),
(5, 'FAQ', 'FAQ', 0, NULL, '2023-06-03 08:38:54'),
(6, 'Terms and Conditions', 'Terms and Conditions', 0, NULL, '2023-06-03 08:38:54'),
(7, 'Privacy Policy', 'Privacy Policy', 0, NULL, '2023-06-03 08:38:54'),
(8, 'Custom Page', 'Custom Page', 1, NULL, '2023-05-10 10:38:09'),
(9, 'Blog', 'Blog', 0, NULL, '2023-06-03 08:38:54'),
(10, 'Contact Us', 'Contact Us', 1, NULL, '2023-05-10 02:10:38');
...
CREATE TABLE `orders` (
  ...
  `appointment_schedule_id` int(10) NOT NULL DEFAULT 0,
...
(1, '39082056', 1, 2, 1, 300, 300, '05-06-2023', 1, '09:00 AM - 06:00 PM', 0, 'Bank Payment', 'pending', 0, NULL, 'Cash On Delivery', 'complete', NULL, NULL, NULL, '', '[]', '{\"name\":\"Nirob Hasan\",\"email\":\"nirob@gmail.com\",\"phone\":\"01632030573\",\"address\":\"Notun Bazar\",\"post_code\":\"1212\",\"order_note\":\"Test\"}', 'Test', 'Yes', '2023-06-04 10:24:43', '2023-06-04 16:04:13', 0),
(2, '588602255', 1, 2, 1, 300, 300, '06-06-2023', 2, '09:00 AM - 06:00 PM', 0, 'Bank Payment', 'pending', 0, NULL, 'COD', 'awaiting_for_provider_approval', NULL, NULL, NULL, '', '[]', '{\"name\":\"Nirob Hasan\",\"email\":\"nirob@gmail.com\",\"phone\":\"01632030573\",\"address\":\"Notun Bazar\",\"post_code\":\"1212\",\"order_note\":\"2nd Order\"}', '2nd Order', NULL, '2023-06-04 10:28:07', '2023-06-04 10:28:07', 0);
...
(1, 1, '01741158857', 1, 'BD', 'BDT', 'This is description', 'uploads/website-images/razorpay-2023-06-04-03-14-56-8425.png', '#2d15e5', 'nHaHpzwaeXxjvN3hqPwlD5Ynch', 'IT9yLGzDMBuJv40EmjhdVJ0mA2AQRAzG3KxoRj7QjPnS30tvosUj', NULL, '2023-06-04 09:14:56');
...
(1, 'Home Page', 'Home page - SeekForServ', 'Home Page', NULL, '2023-06-03 08:34:31'),
(2, 'About Us', 'About Us - SeekForServ', 'About Us', NULL, '2023-06-03 08:34:34'),
(3, 'Contact Us', 'Contact Us - SeekForServ', 'Contact Us', NULL, '2023-06-03 08:34:38'),
(5, 'Service', 'Our Service - SeekForServ', 'Our Service', NULL, '2023-06-03 08:34:41');
...
CREATE TABLE `services` (
  ...
  `approve_by_admin` int(10) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `services` (`id`, `category_id`, `location_id`, `provider_id`, `name`, `slug`, `price`, `image`, `details`, `make_featured`, `make_popular`, `status`, `is_banned`, `seo_title`, `seo_description`, `what_you_will_provide`, `benifit`, `package_features`, `approve_by_admin`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 2, 'OS Installations', 'os-installations', 300, 'uploads/custom-images/Service-2023-06-04-02-49-52-2335.jpg', '<ul>\r\n<li>OS Installation Services</li>\r\n<li>Computer repair &amp; services</li>\r\n<li>Computer Accessory Dealers</li>\r\n<li>Server Installation &amp; Configuration</li>\r\n<li>Computer scanner &amp; printer repair services</li>\r\n<li>Computer AMC services</li>\r\n<li>Photocopier repair &amp; services</li>\r\n</ul>', 0, 0, 1, 0, 'OS Installations', 'OS Installations', '[\"Service Guarantee\",\"Quality Service\",\"Timely Work\"]', '[\"All brand laptop & desktop repair services at the best prices, and we are specialists in laptop Hinge repair and plastic fabrication and chip level service, software issues and virus issues and slow issues. We will resolve it last time. Call for doorstep service.\"]', '', 1, '2023-06-04 08:27:38', '2023-06-04 08:49:52'),
(2, 4, NULL, 2, 'House Cleaning', 'house-cleaning', 500, 'uploads/custom-images/Service-2023-06-04-09-57-37-5956.PNG', '<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', 0, 0, 1, 0, 'House Cleaning', 'House Cleaning', '[\"Service Guarantee\",\"Quality Service\",\"Timely Work\"]', '[\"Service Guarantee\",\"Quality Service\",\"Timely Work\"]', '', 1, '2023-06-04 15:57:37', '2023-06-04 16:02:20'),
(3, 3, NULL, 2, 'Car Wash Service', 'car-wash-service', 400, 'uploads/custom-images/Service-2023-06-04-10-01-49-7923.PNG', '<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', 0, 0, 1, 0, 'Car Wash Service', 'Car Wash Service', '[\"Full Car Inside Cleaning\",\"Car Dashboard, Seat, Ceiling\",\"Deep Cleaning Storage Compartment\"]', '[\"Cleaning Inside Full Car\",\"Antibacterial Deep Steam Wash\"]', '', 1, '2023-06-04 16:01:49', '2023-06-04 16:02:26'),
(4, 1, NULL, 2, 'Web Development', 'web-development', 5000, 'uploads/custom-images/Service-2023-06-05-06-38-01-6831.jpg', '<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>', 0, 0, 1, 0, 'Web Development', 'Web Development', '[\"It\'s depend on your budget.\"]', '[\"You will get your desirer service.\"]', '', 0, '2023-06-05 00:38:01', '2023-06-05 00:38:01');
...
(1, 'Quality Service 24/7', NULL, 'uploads/website-images/slider-2023-06-04-02-20-08-1243.png', 'Hire Experts And Get Your Service Done', NULL, '43434', 'uploads/website-images/slider-2023-01-15-05-42-46-4524.png', 'uploads/website-images/slider-2022-09-22-11-15-09-1295.png', NULL, '2022-01-30 10:25:59', '2023-06-03 20:24:47');
...
(1, 0, '1844188565781706', 'f32f45abcf57a4dc23ac6f2b2e8e2241', 0, '810593187924-706in12herrovuq39i2pbn483otijei8.apps.googleusercontent.com', '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', 'http://localhost/web-solution-us/ecommerce_ibrahim/callback/google', 'http://localhost/web-solution-us/ecommerce_ibrahim/callback/google', NULL, '2023-06-03 08:27:57');
...
(1, 0, 'pk_test_51JU61aF56Pb8BOOX5ucAe5DlDwAkCZyffqlKMDUWsAwhKbdtuY71VvIzr0NgFKjq4sOVVaaeeyVXXnNWwu5dKgeq00kMzCBUm5', 'sk_test_51JU61aF56Pb8BOOXlz7jGkzJsCkozuAoRlFJskYGsgunfaHLmcvKLubYRQLCQOuyYHq0mvjoBFLzV7d8F6q8f6Hv00CGwULEEV', NULL, '2023-06-04 09:02:12', 'US', 'USD', 1, 'uploads/website-images/stripe-2022-09-25-10-04-48-4289.png');
...
(1, 'nirob', 'nirob', 'nirob@gmail.com', NULL, '$2y$10$52/XCYXCzFGUIH4Znjnk7OY8So7n5DpGM6ZHQyKlusPG23zvJ7yL2', NULL, 'fracGv0IIddZHZUl7zINFvoyAe1ow2TYcpA79ykQpSda01tkstIwGmz0jmasnRefpFP3HvFpykOdA01ojkpnQv795WdeOtgV9Ar0', NULL, 1, NULL, NULL, NULL, 'uploads/custom-images/nirob-2023-06-05-06-34-14-1275.jpg', '01632030573', 0, 0, 0, NULL, 'Gulshan, Dhaka', 0, 'Q2V5D9yzZAsWUEIjVBlk3Xv060nxX85U7ifObA3VqXvzTU1LyZ4CRRDqirFbCeJSHGcI4SS72rIhknw0yF6EGCpdUOX5VxWdaZ8b', NULL, 0, 0, NULL, '2023-06-03 19:48:52', '2023-06-05 00:34:15'),
(2, 'sagor', 'sagor', 'sagor@gmail.com', NULL, '$2y$10$esyV1ihYvCRImNo4qhSsy.45RB6XMqcqr/xIsLEPvOA4fbRvekfBW', NULL, NULL, NULL, 1, NULL, NULL, NULL, 'uploads/custom-images/sagor-2023-06-04-05-22-29-5484.png', '01632030573', 1, 1, 11, NULL, 'Notun Bazar, Badda, Dhaka', 1, 'PTPURZ5pPEQyNMp0vD7r93EJpQt6k6WUPPl05zPKdDdsepqWc7LZPLjz15c3Tg0aYZzLdWQJku9pQcnr2PZTLlQgph1v9YmdEjml', NULL, 0, 0, 'Student', '2023-06-03 23:22:29', '2023-06-03 23:24:53'),
(3, 'Web', NULL, 'customer@demo.com', NULL, '$2y$10$CH7GGyF0w0qzeiS6jjup6OzTviMe92ktrJMYJHh6gtCszl3Uf/1DG', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0, 'zhNnubNwQW8HHLdyPT6ayR9RGtARi2q2v5vPV8bafdfIdKC8fAa2tsyULCYdMCLxpxEowj8DI1U2StFa60jjDfDwsD4x98kcVxoE', NULL, 0, 0, NULL, '2023-06-04 23:13:18', '2023-06-04 23:13:18'),
(7, 'algaddafy', 'algaddafy', 'algaddafy@gmail.com', NULL, '$2y$10$U1QFkZlOG3aBzN83895aSuSTCxkbuJe.tqcDa4/fsYdM70oppPBIi', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '01741158857', 1, 1, 12, NULL, 'J Block.', 1, 'SGveCDH2Ev03YQMZMkCQUqkAE7yGI4DhZBOU15NNF6Rc93aCpsIX9llAeIt0TAPZYkJXv1jbzMvVqyBgcxzQzf0cM2ewDFoeQQ4C', NULL, 0, 0, 'Developer', '2023-06-05 00:28:31', '2023-06-05 00:28:31');
