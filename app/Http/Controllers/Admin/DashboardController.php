...
class DashboardController extends Controller
{
    ...
    public function dashobard(){
        ...
        return view('admin.dashboard', compact('currency_icon','today_total_order','today_total_awating_order','today_approved_order','today_complete_order','today_declined_order','today_total_earning','today_withdraw_request','today_users','monthly_total_order','monthly_total_awating_order','monthly_approved_order','monthly_complete_order','monthly_declined_order','monthly_total_earning','monthly_withdraw_request','monthly_users','yearly_total_order','yearly_total_awating_order','yearly_approved_order','yearly_complete_order','yearly_declined_order','yearly_total_earning','yearly_withdraw_request','yearly_users','total_total_order','total_total_awating_order','total_approved_order','total_complete_order','total_declined_order','total_total_earning','total_withdraw_request','total_users','total_service','total_providers','total_clients'));
    }
